    ...
    <TooltipPrimitive.Root open={isOpen}>
      ...
      <TooltipPrimitive.Portal>
        <TooltipPrimitive.Content
          className={`${inter.className} z-50 max-w-sm rounded-lg bg-blue px-4 py-2 text-center font-sans text-sm font-normal text-white shadow-md ui-state-closed:animate-fade-out ui-state-delayed-open:animate-fade-in ui-state-open:animate-fade-in`}
          sideOffset={6}
        >
          {label}
